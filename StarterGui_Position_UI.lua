--// StarterGui Position UI Script
--// UI otomatis muncul untuk semua player yang join
--// Mobile Optimized dengan Auto-Loading
...
if IS_MOBILE then
    ...
    if UserInputService:GetPlatform() == Enum.Platform.Android or UserInputService:GetPlatform() == Enum.Platform.IOS then
...
-- Update UI with all player data
...
local function initialize()
    print("[StarterGui Position UI] Initializing...")
    ...
    print("[StarterGui Position UI] System initialized successfully!")
